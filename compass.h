...
// Function prototypes to make this compile in a header file
...
float Declination = -14.40;       // magnetic declination of Somerville, MA
...
//  digitalWrite(myLed, HIGH);
  ...
  Serial.println("");
  pixels_set_all(0,0,25);
  Serial.println("NAT 1");
  pixels.show();
  Serial.println("NAT 2");
  delay(2000);
  Serial.println("NAT 3");

  // ----- Read the WHO_AM_I register, this is a good test of communication
  byte c = readByte(MPU9250_ADDRESS, WHO_AM_I_MPU9250);  // Read WHO_AM_I register for MPU-9250
  Serial.println("NAT 4");
  delay(1000);
  Serial.println("NAT 5");
